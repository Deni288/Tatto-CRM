        ...
        <div className="space-y-6 md:space-y-8 max-w-7xl mx-auto pb-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative">
                ...
                <div className="hidden sm:flex gap-3">
                    <Button onClick={handleCopyBookingLink} variant="gold" className="shadow-lg hover:shadow-xl transition-all h-10">
                        {linkCopied ? <Check size={18} className="mr-2" /> : <Link size={18} className="mr-2" />}
                        {linkCopied ? 'Copied!' : 'Booking Link'}
                    </Button>
                    <Button onClick={() => navigate('/dashboard/appointments')} variant="gold" className="shadow-lg hover:shadow-xl transition-all h-10">
