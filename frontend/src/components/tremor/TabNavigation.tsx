...
function getSubtree(
  ...
  return React.cloneElement(firstChild as React.ReactElement<any>, {
    children:
...
>(({ className, children, ...props }, forwardedRef) => (
  <NavigationMenuPrimitives.Root ref={forwardedRef} {...props} asChild={false}>
    <NavigationMenuPrimitives.List
      className={cx(
        // base
        "flex items-center justify-start whitespace-nowrap overflow-x-auto border-b [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
        // border color
